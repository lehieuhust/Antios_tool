...
def generate_windows_fingerprint():
    ...
    logger.info("Random digital product ID {0}".format(system_fp.random_digital_product_id()))
    logger.info("Random digital product ID 4 {0}".format(system_fp.random_digital_product_id4()))
    logger.info("Random IE service update {0}".format(system_fp.random_ie_service_update()))
    logger.info("Random IE install data {0}".format(system_fp.random_ie_install_date()))
...
def generate_hardware_fingerprint():
    ...
    logger.info("Random Windows Update Validation ID {0}".format(hardware_fp.random_win_update_guid()))
